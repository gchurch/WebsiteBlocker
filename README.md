...
The extension is published to the Edge and Chrome extension stores. At the time of writing, the Edge version has 873 active users and 15 ratings with an average of 4.5 stars.
